...
Maximum mean number of steps per interval is `r max_mean_steps[2]`,and corresponding interval is `r max_mean_steps[1]`.
...
Prior to the substitution there were `r total_na` missing values. 
